    ...
    public partial class Populadb : Migration
    {
        protected override void Up(MigrationBuilder mb)
        {
            ...
            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque," +
                "DataCadastro,CategoriaId) Values('Coca-Cola Diet', 'Refrigerante de Cola 350ml', 5.45, " +
                "'http://www.macorattti.net/Imagens/coca.jpg',50, now()," +
                "(Select CategoriaId from Categorias where Nome='Bebidas'))");
            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque," +
               "DataCadastro,CategoriaId) Values('Lanche de Atum', 'Lanche de Atum com maionese', 5.45, " +
               "'http://www.macorattti.net/Imagens/atum.jpg',15, now()," +
               "(Select CategoriaId from Categorias where Nome='Lanches'))");
            mb.Sql("Insert into Produtos(Nome,Descricao,Preco,ImagemUrl,Estoque," +
               "DataCadastro,CategoriaId) Values('Pudim 100g', 'Pudim de leite condensado 100g', 5.45, " +
               "'http://www.macorattti.net/Imagens/pudim.jpg',30, now()," +
